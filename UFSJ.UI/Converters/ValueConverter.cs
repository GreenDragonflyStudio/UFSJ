...
namespace UFSJ.Converters
{
    public class ValueConverter : MarkupExtension, IValueConverter
    {
        ...
        /// </returns>
        public virtual object MultiConvert(object[] values, Type targetType, object parameter, CultureInfo culture) => throw new NotImplementedException();
        ...
        /// </returns>
        /// <exception cref="T:System.NotImplementedException"></exception>
        public virtual object[] MultiConvertBack(object value, Type[] targetTypes, object parameter, CultureInfo culture) => throw new NotImplementedException();
        ...
        /// <returns></returns>
        public object Convert(object value) => this.Convert(value, null);
        ...
        /// <returns></returns>
        public object Convert(object value, object parameter) => this.Convert(value, null, parameter, null);
        ...
        /// <param name="value">The value.</param>
        /// <returns></returns>
        public object ConvertBack(object value) => this.ConvertBack(value, null);
        ...
        /// <param name="parameter">The parameter.</param>
        /// <returns></returns>
        public object ConvertBack(object value, object parameter) => this.ConvertBack(value, null, parameter, null);
        ...
        /// <returns></returns>
        public object MultiConvert(object[] values) => this.MultiConvert(values, null);
        ...
        /// <param name="parameter">The parameter.</param>
        /// <returns></returns>
        public object MultiConvert(object[] values, object parameter) => this.MultiConvert(values, null, parameter, null);
        ...
        /// <param name="value">The value.</param>
        /// <returns></returns>
        public object[] MultiConvertBack(object value) => this.MultiConvertBack(value, null);
        ...
        /// <param name="parameter">The parameter.</param>
        /// <returns></returns>
        public object[] MultiConvertBack(object value, object parameter) => this.MultiConvertBack(value, null, parameter, null);
